#!/bin/bash
# Restore PostgreSQL Vector Collections for exp3
# This script restores the vectors schema from a backup file

echo "============================================================"
echo "Restoring PostgreSQL Vector Collections (exp3)"
echo "============================================================"
...
if [ -z "$1" ]; then
    ...
    BACKUP_FILE=$(ls -t ./experiment_results/backups/exp3_vectors_backup_*.sql 2>/dev/null | head -n 1)
    if [ -z "$BACKUP_FILE" ]; then
        echo "[ERROR] No backup files found in ./experiment_results/backups/"
...
echo "  Schema: $SCHEMA_NAME"
echo ""
echo "You can now run experiments using the restored collections."
echo "============================================================"
