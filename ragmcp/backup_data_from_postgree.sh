#!/bin/bash
# Backup PostgreSQL Vector Collections
# This script backs up the vectors schema containing all embeddings
...
BACKUP_FILE="${BACKUP_DIR}/vectors_backup_${TIMESTAMP}.sql"
...
echo "  ./restore_data_to_postgree.sh \"$BACKUP_FILE\""
echo "============================================================"
