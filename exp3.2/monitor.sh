#!/bin/bash
# One-shot status dump for the background run_cross_experiment.sh run.
...
echo ""
echo "================================================================"
echo "Latest log tail (logs/cross_run_*.log)"
echo "================================================================"
LATEST_LOG=$(ls -t logs/cross_run_*.log 2>/dev/null | head -1)
